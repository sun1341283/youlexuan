...
import com.youlexuan.sellergoods.service.SpecificationOptionService;
...
public class SpecificationOptionController {
	 ...
	 * @return
	 */
	@RequestMapping("/findOneBySpec")
	public List<TbSpecificationOption >findOneBySpec(Long id){
		return specificationOptionService.findOneBySpec(id);
	}
